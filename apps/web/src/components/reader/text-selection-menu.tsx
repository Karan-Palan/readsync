...
import { BookMarked, Lightbulb, List, MessageSquare, Sparkles } from "lucide-react";
...
interface TextSelectionMenuProps {
	...
	onAIAction: (highlight: Highlight, action: "EXPLAIN" | "SUMMARIZE" | "EXTRACT") => void;
...
export default function TextSelectionMenu({
	...
	const createAndPerformAction = useCallback(
		...
		[bookId, selectedText, createHighlightMutation, onHighlightCreated, onAIAction],
	);
	...
	return (
		<div
			ref={menuRef}
			className="bg-card fixed z-50 flex items-center gap-0.5 rounded-lg border p-1 shadow-xl"
			style={{
				left: menuPosition.x,
				top: menuPosition.y,
